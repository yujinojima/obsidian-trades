---
title: "Polymarket — LoL: Natus Vincere vs Karmine Corp (BO3) - LEC Regular Season"
type: polymarket-market
slug: lol-navi-kc-2026-04-24
...
spread: 0.0010
liquidity_usd: 414244
volume_24h_usd: 330930
hours_to_close: 3.5
global_safety_gate: FAIL
---

# LoL: Natus Vincere vs Karmine Corp (BO3) - LEC Regular Season
...
| midpoint | 0.0005 |
| spread | 0.0010 |
| liquidity (USD) | $414,244 |
| 24h volume (USD) | $330,930 |
| 24h price change | -0.3245 |
| hours to close | 3.5 |
| end_date | 2026-04-24T23:40:00Z |
| category | (uncategorised) |
| low-price side | Natus Vincere @ 0.0005 |
| low-price token | `114980886641103712278139645623960324138840659416598966357530530040049000308872` |
...
- **Decision:** `skip`
- **Risk score:** 0.510
- **Reason:** closes in 3.5h (< 7 days); large 24h move -0.325 suggests active news flow
...
- **Expected edge / share:** +0.1623
- **Confidence:** 0.25
- **Decision:** `paper_trade`
- **Risk score:** 0.710
- **Reason:** endgame drift -0.325 with 3.5h remaining; PAPER ONLY per spec
